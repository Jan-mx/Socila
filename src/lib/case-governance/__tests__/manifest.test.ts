...
function sampleInput(overrides: Partial<RclManifestInput> = {}): RclManifestInput {
  return {
    ...
    newCases: [
      { rowId: 1, uid: "RPC-310000-SH-A-V1", contentHash: "h-case-1", jurisdictionCode: "310000", qualityScore: 80, qualityBreakdown: { input: 40 }, multiLabels: ["male"], snapshotId: "snap-1", snapshotHash: "snap-h-1", sourceTestUid: "RPCT-310000-SH-A-V1" },
      { rowId: 2, uid: "RPC-440000-GD-A-V1", contentHash: "h-case-2", jurisdictionCode: "440000", qualityScore: 85, qualityBreakdown: { input: 40 }, multiLabels: ["female"], snapshotId: "snap-2", snapshotHash: "snap-h-2", sourceTestUid: "RPCT-440000-GD-A-V1" },
    ],
    ...
    newTests: [
      { rowId: 21, uid: "RPCT-310000-SH-A-V1", contentHash: "h-test-1", jurisdictionCode: "310000", sourceCaseUid: "RPC-310000-SH-A-V1" },
      { rowId: 22, uid: "RPCT-440000-GD-A-V1", contentHash: "h-test-2", jurisdictionCode: "440000", sourceCaseUid: "RPC-440000-GD-A-V1" },
    ],
