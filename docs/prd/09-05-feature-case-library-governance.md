...
> Author: Jan
> Status: Reopened（2026-09-10第四轮复审；持久替换仍待WI-20260907-04授权）
> Updated: 2026-09-10
...
| 状态 | Reopened（2026-09-10第四轮复审：归档补偿、applied幂等重验、迁移换行审计与可信归档持久化）；持久库替换仍由WI-20260907-04在fresh授权后执行 |
| 前置依赖 | 任务2首期Accepted；任务3经`WI-20260907-02`修复并重新Accepted；WI-20260907-03第四轮修复中（Reopened） |
