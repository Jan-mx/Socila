...
## 16. 分地区交付范围决策（2026-09-07，文档决策）

本节记录ADR-0010产生的当前范围，不改写§1～§15历史执行事实。本轮只修改规格和状态文档，未执行代码修改、数据库写入、管理员批准、快照创建、案例删除或地区激活。
...
- 广东失业保险金金额公式“领取地市最低工资×0.9”必须在任务2实现；任务3只传递用户确认的领取地市。
