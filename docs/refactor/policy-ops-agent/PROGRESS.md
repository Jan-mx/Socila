...
| 国家baseline及粤川权威政策 | Reopened（2026-09-06）：持久库已按授权完成一次0014迁移与一次四包repair（批次4→8、成员74→78，零漂移、幂等、地区阻断语义保持，37表恢复对账前后全一致） | 补齐粤川权威来源缺口→管理员批准→四地区候选快照，任务2方可恢复Accepted |
