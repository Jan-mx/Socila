...
| 任务4：上海/广东政策案例库全量重建 | Reopened | 补旧test真实hash、restore/SHA/selection验证、42 example原子同步和manifest自校验 |
| 持久库旧案例替换 | Reopened | 当前36/36/78冻结；完成可信归档与账本/manifest只读审计后另行授权repair-forward |
